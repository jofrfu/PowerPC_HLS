...
//#pragma HLS pipeline
	...
	floating_point_decode_result.execute = floating_point::NONE;
	...
	switch(instruction.I_Form.OPCD) {
		...
		case 20: // rlwimi, rlwimi.
            ...
            rotate_decoded.shift = false;
            rotate_decoded.left = false;
            rotate_decoded.sign_extend = false;
		...
		case 31:
			switch(instruction.X_Form.XO) {
				...
				case 21: // ldx
					...
					break;
				case 23: // lwzx
					fixed_point_decode_result.execute = fixed_point::LOAD;
				...
				case 149: // stdx
					...
					break;
				case 151: // stwx
					fixed_point_decode_result.execute = fixed_point::STORE;
					decode_load_store_and_zero_x_form(load_store_decoded, instruction, 4)
					break;
				case 181: // stdux
					// NOT SUPPORTED!!!
				...
				case 533: // lswx
				    fixed_point_decode_result.execute = fixed_point::LOAD_STRING;
				...
				case 597: // lswi
					...
					break;
				case 661: // stswx
                    fixed_point_decode_result.execute = fixed_point::STORE_STRING;
                    if(instruction.X_Form.RA == 0) {
                        load_store_decoded.sum1_imm = true;
                        load_store_decoded.sum1_immediate = 0;
                        load_store_decoded.sum1_reg_address = 0;
				...
				case 8: // subfc, subfc., subfco, subfco.
					fixed_point_decode_result.execute = fixed_point::ADD_SUB;
				...
				case 11: // mulhwu, mulhwu.
					fixed_point_decode_result.execute = fixed_point::MUL;
				...
				case 459: // divwu, divwu., divwuo, divwuo.
					fixed_point_decode_result.execute = fixed_point::DIV;
				...
				case 0: // cmp
					{
						...
						fixed_point_decode_result.execute = fixed_point::COMPARE;
				...
				case 68: // td
					...
					break;
				case 4: // tw
					fixed_point_decode_result.execute = fixed_point::TRAP;
				...
				case 24: // slw, slw.
					...
					rotate_decoded.shift_imm = false;
                    rotate_decoded.shift_immediate = 0;
                    rotate_decoded.shift_reg_address = instruction.X_Form.RB;
                    rotate_decoded.source_reg_address = instruction.X_Form.RT;
                    rotate_decoded.target_reg_address = instruction.X_Form.RA;
                    rotate_decoded.MB = 0;
                    rotate_decoded.ME = 0;
                    rotate_decoded.mask_insert = false;
                    rotate_decoded.shift = true;
                    rotate_decoded.left = true;
                    rotate_decoded.sign_extend = false;
					if(instruction.X_Form.Rc == 1) {
                        rotate_decoded.alter_CR0 = true;
					} else {
				...
				case 792: // sraw, sraw.
                    ...
                    rotate_decoded.shift = true;
                    rotate_decoded.left = false;
                    rotate_decoded.sign_extend = true;
					if(instruction.X_Form.Rc == 1) {
                        rotate_decoded.alter_CR0 = true;
					} else {
                        rotate_decoded.alter_CR0 = false;
				...
				case 824: // srawi, srawi.
					fixed_point_decode_result.execute = fixed_point::ROTATE;
                    rotate_decoded.shift_imm = true;
                    rotate_decoded.shift_immediate = instruction.X_Form.RB;
                    rotate_decoded.shift_reg_address = 0;
                    rotate_decoded.source_reg_address = instruction.X_Form.RT;
                    rotate_decoded.target_reg_address = instruction.X_Form.RA;
                    rotate_decoded.MB = 0;
				...
				case 19: // mfcr
					fixed_point_decode_result.execute = fixed_point::SYSTEM;
				...
				case 535: // lfsx
					floating_point_decode_result.execute = floating_point::LOAD;
				...
				case 631: // lfdux
					...
					break;
				case 663: // stfsx
					floating_point_decode_result.execute = floating_point::STORE;
					decode_load_store_and_zero_x_form(float_load_store_decoded, instruction, 4)
					break;
				case 695: // stfsux
					floating_point_decode_result.execute = floating_point::STORE;
		...
		case 63:
			switch(instruction.X_Form.XO) {
				...
				case 40: // fneg, fneg.
					floating_point_decode_result.execute = floating_point::MOVE;
				...
				case 12: // frsp, frsp.
					floating_point_decode_result.execute = floating_point::CONVERT;
				...
				case 0: // fcmpu
					floating_point_decode_result.execute = floating_point::COMPARE;
				...
				case 38: // mtfsb1, mtfsb1.
					floating_point_decode_result.execute = floating_point::STATUS;
			...
			switch(instruction.A_Form.XO) {
				...
				case 18: // fdiv, fdiv.
					floating_point_decode_result.execute = floating_point::ARITHMETIC;
				...
				case 28: // fmsub, fmsub.
					floating_point_decode_result.execute = floating_point::MADD;
